        ...
        <head>
            ...
            <script>
                ...
                function ScanQRForIssue() {
                                        ...
                                        scanner.addListener('scan', function (content) {
                                          ...
                                          $.ajax({
                                                    ...
                                                    success: function(result){
                                                        alert(result.success+" bid "+result.bid+" bname "+result.bookname+" author "+result.authorname+" issuedto "+result.issuedto);
                                                        
        
                                                                if(result.issuedto==null){
                                                                        $.ajax({
                                                                        type: "POST",
                                                                        url: "admin/issueBookForm.jsp",
                                                                        data: {
                                                                                    'bid' : result.bid,
                                ...
                                xmlhttp.open("GET","admin/issueBook.jsp",true);
                                xmlhttp.send();
                            }
            ...
            function ScanQRForReturn() {
                ...
                function ReIssueBook() {
                                ...
                                xmlhttp.open("GET","admin/reissueBook.jsp",true);
                                xmlhttp.send();
                            }
                ...
                <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav side-nav">
                            ...
                            <li class="">
                                <a style="cursor: pointer;"><div onclick="AddBook()"><i class="fa fa-fw fa-book"></i>Add Book</div></a>
                            </li>
                             <li class="">
                                <a style="cursor: pointer;"><div onclick="RemoveBook()"><i class="fa fa-fw fa-book"></i>Remove Book</div></a>
                            </li>
                            <li class="">
                                <a style="cursor: pointer;"><div onclick="ScanQRForIssue()"><i class="fa fa-fw fa-book"></i>Issue a Book</div></a>
                            </li>
                            <li class="">
                                <a style="cursor: pointer;"><div onclick="ScanQRForReturn()"><i class="fa fa-fw fa-book"></i>Return a Book</div></a>
                            </li>
                            <li class="">
